...
?>
    ...
    <body class="pt-4 mt-4">
        ...
        <main class="mt-5 pt-4 px-sm-2">
                    ...
                    <div class="row my-sm-3">
                        ...
                        <div class="col-12 col-sm-4 col-md-3 mb-2">
                            <div class="input-group">
                                ...
                                <input type="text" value="<?php echo 2; ?>" class=" border-0 form-control text-center" readonly>
                            </div>
                        </div>
                    </div>
                    <!-- hilera 3 -->
                    <div class="row my-sm-3">
                        ...
                        <div class="col-12 col-sm-4 col-lg-3  mb-2">
                            <div class="input-group">
                                ...
                                <input type="text" value="<?php echo 4; ?> h" class=" border-0 form-control text-center" readonly>
                            </div>
                        </div>
                    </div>
                    <!-- hilera 4 -->
            ...
            <div class="border border-4 border-primary rounded-3 mt-3 d-none">
