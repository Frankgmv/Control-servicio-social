...
-- SELECT COUNT(*) FROM POSTULADOS WHERE ID_TAREA = "";
-- INSERT INTO POSTULADOS(ID_POSTULACION, ID_POSTULADO, ID_TAREA, FECHA_POSTULACION, ESTADO_POSTULACION) VALUES ('');
...
INSERT INTO TAREAS (ID_TAREA, ID_CREADOR, NOMBRE_TAREA, DESCRIPCION, FECHA_CREACION, FECHA_LIMITE, NUMERO_HORAS, OBJETIVO, PARA_QUE_GRADO, ESTADO_TAREA, N_PERSONAS) 
VALUES ( '1', '1234', 'Berrer patio.', 'Hacer Aseo en las horas de la mañana al patio principal.', '2022-8-22', '2022-8-23', 3, 'Terminar el mismo día.', 'todos','Terminada', 4);

INSERT INTO POSTULADOS (ID_POSTULACION, ID_POSTULADO, ID_TAREA, FECHA_POSTULACION, ESTADO_POSTULACION)
VALUES ('1', '1010', '1', '2022-8-22', 'Terminada');

INSERT INTO POSTULADOS (ID_POSTULACION, ID_POSTULADO, ID_TAREA, FECHA_POSTULACION, ESTADO_POSTULACION)
VALUES ('2', '105', '1', '2022-8-22', 'Terminada');


INSERT INTO HORAS (ID_DATO, ID_ESTUDIANTE, ID_TAREA, NOMBRE_TAREA, FECHA_CREACION, HORAS) 
VALUES ('1', '1010', '1', 'Berrer patio.', '2022-8-22', 4);
